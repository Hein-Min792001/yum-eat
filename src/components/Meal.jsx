        ...
        <div className='max-w-[1520px] m-auto px-4 py-12'>
            ...
            <div className="flex flex-col lg:flex-row justify-center">
                <div className="flex justify-center md:justify-center my-2">
                    <button className='m-1 py-1 px-12 rounded border-orange-700 text-white bg-orange-700
                    ...
                    foods.map((item) => (
                        <div key={item.id} className='border-none hover:scale-105 duration-300'>
                            ...
                            <div className="flex justify-between py-2 px-4">
                                ...
                                <p className='bg-orange-700 py-4 px-2
                         border-8 h-18 w-18 rounded-full -mt-10'>{item.price}</p>
                            </div>
                            <div className="pl-2 py-4">
                                <span className='item-center text-indigo-600'>View More</span>
                                <BsArrowRight size={25} className='w-4 ml-2 inline' />
                            </div>
                        </div>
                    ))
                }
